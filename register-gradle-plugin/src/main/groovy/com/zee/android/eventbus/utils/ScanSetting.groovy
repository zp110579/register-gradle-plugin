...
//    static final String GENERATE_TO_CLASS_NAME = 'com/alibaba/android/arouter/core/LogisticsCenter'
    static final String GENERATE_TO_CLASS_NAME = 'com/zee/utils/ZConfig'
     ...
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/zee/autocreate/'
...
//    private static final INTERFACE_PACKAGE_NAME = 'org/greenrobot/eventbus/interfaces/'
    ...
    ScanSetting(String interfaceName) {
        if(interfaceName.equals("SubscriberInfoIndex")) {
            this.interfaceName = "org/greenrobot/eventbus/interfaces/" + interfaceName
        }else{
            this.interfaceName = "com/zee/interf/" + interfaceName
        }
    }
